...
function lerLetrasKeyboard (ind, letra, keyCodeEquivalente) {
    x1mt = 50;
    x2lt = 80;
    for (cont = 0; cont <= selecionado.length -1 && cont <= 4; cont ++) {
    ...
    x1mt = 50;
    x2lt = 80;
    for (cont = 5; cont <= selecionado.length -1 && cont <= 9; cont ++) {
    if (keyCodeEquivalente == alfabeto[ind] && selecionado[cont].includes(letra)) {
        lapis.strokeStyle = 'black';
        lapis.lineWidth = 2;
        lapis.font = '40px serif';
    ...
    x1mt = 50;
    x2lt = 80;
    for (cont = 10; cont <= selecionado.length -1 && cont <= 14; cont ++) {
    if (keyCodeEquivalente == alfabeto[ind] && selecionado[cont].includes(letra)) {
        lapis.strokeStyle = 'black';
        lapis.lineWidth = 2;
        lapis.font = '40px serif';
    ...
    x1mt = 50;
    x2lt = 80;
    for (cont = 15; cont <= selecionado.length -1 && cont <= 19; cont ++) {
    if (keyCodeEquivalente == alfabeto[ind] && selecionado[cont].includes(letra)) {
        lapis.strokeStyle = 'black';
        lapis.lineWidth = 2;
        lapis.font = '40px serif';
    ...
    x1mt = 50;
    x2lt = 80;
    for (cont = 20; cont <= selecionado.length -1 && cont <= 24; cont ++) {
    if (keyCodeEquivalente == alfabeto[ind] && selecionado[cont].includes(letra)) {
        lapis.strokeStyle = 'black';
        lapis.lineWidth = 2;
        lapis.font = '40px serif';
